...
import 'package:randomizer/screens/randomizer/group_builder/group_builder.dart';
...
final Map<String, Widget Function(BuildContext)> routes = {
  ...
  RouteName.addGroupList: (context) => const AddGroupListScreen(),
  ...
  RouteName.groupBuilder: (context) => const GroupBuilderScreen(),
